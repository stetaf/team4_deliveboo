...
@section('content')    
    ...
    <div class="sep p-4">
        <div class="container">
            <div class="row row-cols-sm-2 row-cols-md-4 row-cols-lg-6">
                <div v-for="type in types" class="my-3 col d-flex align-items-center flex-column">
                    <div class="type">
                        <img :src="/img/ + type.image" width="45" @click="filterBy(type.id)">
                        <small class="">@{{ type.name }}</small>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="results">
        <div class="container">
            <div class="row row-cols-sm-6 row-cols-md-6 row-cols-lg-6">
